...
class CellState:
    ...
    def __init__(self):
        self.pressure_oil_water = np.zeros((Layer.dim, Layer.components_count))
        self.pressure_cap = np.zeros((Layer.dim, 1))
        self.s_oil_water = np.zeros((Layer.dim, Layer.components_count))
        self.ro_oil_water = np.zeros((Layer.dim, Layer.components_count))
        self.k_r_oil_water = np.zeros((Layer.dim, Layer.components_count))
        self.fi = np.zeros((Layer.dim, 1))
    ...
    #Setters
    # Здесь устанавливаем по столбцам
    ...
    #Set n to n plus 1
    # TODO: Пересмотреть переприсванивание
